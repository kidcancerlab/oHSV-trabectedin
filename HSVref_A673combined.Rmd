...
```{r process, fig.height=3, fig.width=3, dependson="lib"}
# Set seed
set.seed(888)
...
```{r abundexp, dependson = c("matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
#### Abundance ####
...
```{r hsv_patchwork_cutoff15, fig.height = 12, fig.width = 16, dependson = "hsv_timepoints"}
hsv_patchwork_hi <- 
...
```{r hsv_patchwork_cutoff1, fig.height = 12, fig.width = 16, dependson = "hsv_timepoints"}
hsv_patchwork_lo <- 
...
```{r hsv-vln, height = 15, width = 7, dependson = "hsv_timepoints"}
for (hsv_time in names(hsv_timepoints)) {
...
```{r hsv-vln2, dependson="hsv_timepoints"}
Idents(A673_hsv_comb_even) <- A673_hsv_comb_even$treatment
...
```{r hsvpath_exp, dependson = "deg-trt-0"}

...
```{r process, fig.height=3, fig.width=3, dependson=c("load","load-final")}
...
#### Res0.1
```{r umap, fig.height=5, fig.width=10, dependson=c("load","load-final","process")}
K7M2_hsv <- 
...
#### Res0.2
```{r umap2, fig.height=5, fig.width=10, dependson=c("load","load-final","process")}
K7M2_hsv <- 
...
#### Res0.3
```{r umap3, fig.height=5, fig.width=10, dependson=c("load","load-final","process")}
K7M2_hsv <- 
  FindClusters(K7M2_hsv,
               resolution = 0.3)
...
#### Res0.5
```{r umap5, fig.height=5, fig.width=10, dependson=c("load","load-final","process")}
K7M2_hsv <- 
  FindClusters(K7M2_hsv,
               resolution = 0.5)
...
#### Res0.7
```{r umap7, fig.height=5, fig.width=10, dependson=c("load","load-final","process")}
K7M2_hsv <- 
  FindClusters(K7M2_hsv,
               resolution = 0.7)
...
```{r downsample, fig.height=5, fig.width=10, dependson=c("load","load-final","process","umap","umap5")}
...
```{r deg, dependson = c("load","load-final","process","umap","umap5","downsample")}
...
```{r degt, dependson=c("load","load-final","process","umap","umap5","downsample","deg")}
...
```{r degt-trt, dependson=c("load","load-final","process","umap","umap5","downsample","deg")}
...
```{r singlr, dependson=c("load","load-final","process","umap","umap5","downsample")}
...
```{r singler_cont, dependson=c("load","load-final","process","umap","umap5","downsample","singlr")}
...
```{r singlr_plot, dependson=c("load","load-final","process","umap","umap5","downsample","singlr")}
...
```{r singlr_plot2, fig.width=12, fig.height=5, dependson=c("load","load-final","process","umap","umap5","downsample","singlr")}
# Rename cell ids
K7M2_hsv_even <- 
...
```{r cell_marker, dependson=c("load","load-final","process","umap","umap5","downsample")}
Idents(K7M2_hsv_even) <- K7M2_hsv_even$RNA_snn_res.0.5
...
```{r cell_marker_ft, fig.height = 12, fig.width = 12, dependson=c("load","load-final","process","umap","umap5","downsample")}
Idents(K7M2_hsv_even) <- K7M2_hsv_even$RNA_snn_res.0.5
...
```{r clust_ids,dependson=c("load","load-final","process","umap","umap5","downsample")}
...
### nkt closer look
```{r nkdegt-trt, dependson="deg", fig.height = 6, fig.width = 15,eval=FALSE}
Idents(nkt) <- nkt$treatment
nkt_markers <- FindAllMarkers(nkt,
                              min.pct = 0.25,
                              logfc.threshold = 0.25,
                              only.pos = F)
...
```{r cell_subset, message = TRUE, eval = FALSE}
library(cowplot)
...
for (cell_id in levels(K7M2_hsv_even)) {
  ...
  if (min(table(cell_type$treatment)) > 50) {
    ...
    if (nrow(gsea_KEGG) > 0) {
      #plots[["KEGG"]][[cell_id]] <- 
      # pdf(file = paste0("Plots/K7M2_2/kegg_", cell_id, ".pdf"),
      #     height = 10,
      #     width = 10)
      #print(
        enrichplot::dotplot(gsea_KEGG,
    ...
    print(plots[["KEGG"]][[cell_id]])
    #plot_grid(plotlist = plots[["KEGG"]], ncol = 3)
...
```{r ifng,dependson=c("load","load-final","process","umap","umap5","downsample")}
...
```{r dgea,dependson=c("load","load-final","process","umap","umap5","downsample")}
library(msigdbr)
...
```{r matthelp_hsvgenes,dependson=c("load","load-final","process","umap","umap5","downsample")}
...
```{r hsv_genes,dependson=c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes")}
...
```{r matthelp_assaydata,dependson=c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes")}
...
```{r tibble_hist, dependson=c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata")}
...
```{r tibble_hist_log, dependson=c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata")}
...
```{r new_hsv_meta, dependson=c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata")}
...
```{r hsvhist,dependson=c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata")}
...
```{r hsvdimplot, fig.height=5, fig.width=10, dependson=c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
...
```{r featurehsv, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
FeaturePlot(K7M2_hsv_even,
...
```{r feature_trt_hsv, fig.height = 3, fig.width = 12, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
FeaturePlot(K7M2_hsv_even,
            split.by="treatment",
            features = "oHSV_abundance",
            order = TRUE) +
...
```{r feature_trt_hsv_100, fig.height = 3, fig.width = 12, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
# Max cutoff at 100
FeaturePlot(K7M2_hsv_even,
            split.by="treatment",
            features = "oHSV_abundance",
...
```{r feature_trt_hsv_50, fig.height = 3, fig.width = 12, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
# Max cutoff at 50
FeaturePlot(K7M2_hsv_even,
            split.by="treatment",
            features = "oHSV_abundance",
...
```{r feature_trt_hsv_20, fig.height = 3, fig.width = 12, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
# Max cutoff at 20
FeaturePlot(K7M2_hsv_even,
            split.by="treatment",
            features = "oHSV_abundance",
...
```{r feature_trt_hsv_5, fig.height = 3, fig.width = 12, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
# Max cutoff at 5
...
```{r vlnhsv, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
Idents(K7M2_hsv_even) <- K7M2_hsv_even$treatment
...
```{r hsvab, dependson = c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
Idents(K7M2_hsv_even) <- K7M2_hsv_even$treatment
...
```{r numbers, dependson= c("load","load-final","process","umap","umap5","downsample","matthelp_hsvgenes","matthelp_assaydata","new_hsv_meta")}
...
```{r deg-trt,dependson=c("load","load-final","process","umap","umap5","downsample")}
trtdiff <- FindMarkers(K7M2_hsv_even,
                       ident.1 = "4 - oHSV+Trabectedin",
                       ident.2 = "2 - oHSV",
                       logfc.threshold = 0.15,
...
```{r kegg,dependson=c("load","load-final","process","umap","umap5","downsample","deg-trt")}
conversion <-
  clusterProfiler::bitr(geneID = names(degs),
                        fromType = "SYMBOL",
                        toType = "ENTREZID",

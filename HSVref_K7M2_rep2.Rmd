...
```{r singlr_plot2, fig.width=12, fig.height=5, dependson=c("define_samples","load","load-final","downsample","process","umap","umap5","downsample","singlr", "singler_cont")}
# Rename cell ids under identity "SingleR2ed" in metadata 
krecurlustered <- 
  RenameIdents(krecurlustered,
               "Dendritic cells" = "DC",
               "Tgd" = "T cells",
...
*Figure 4B - Activated NK and CD8 T cells*

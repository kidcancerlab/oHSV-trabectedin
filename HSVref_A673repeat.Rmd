...
log_ab
# save as pdf
pdf("vln_log_hsvabundance.pdf",
    height = 5, width = 5)
print(log_ab)
dev.off()

pdf("vln_log_hsvabundance2.pdf",
    height = 2, width = 8)
print(log_ab)
dev.off()
...
for (trtmnt in levels(A673_hsv_even)) {
  ...
  print(ab_hist)
  # Save as pdf
  pdf(paste0("abundancehist_", trtmnt, ".pdf"),
      height = 5, width = 5)
  print(ab_hist)
  dev.off()
}
...
# Create FeaturePlots based on the timepoint module scores
  ...
  pdf(paste0("rfeaturecutoff1_", hsv_time, trtmnt),
      height = 5, width = 10)
  print(plots[[paste0(hsv_time, "rfeatureplot_plot_cutoff1")]])
  dev.off()
}
...
for (trtmnt in c("2 - oHSV", "4 - oHSV+Trabectedin")) {
  for (hsv_time in names(hsv_timepoints)) {
    ...
    # Save as pdf
    pdf(paste0("hist_", hsv_time, "_", trtmnt, ".pdf"),
        height = 5, width = 5)
    print(plots[[paste0(hsv_time, "_hist")]][[trtmnt]])
    dev.off()
  }
...
for (trtmnt in c("2 - oHSV", "4 - oHSV+Trabectedin")) {
  ...
  pdf(paste0("ridge_p2", hsv_time, trtmnt, ".pdf"),
      height = 5, width = 10)
  print(ridge)
  dev.off()
     }
...
print(feature)
pdf("featureplot_time.pdf", height = 12.5, width = 8.25)
print(feature)
dev.off()
...
pdf("vlnplot_time.pdf", height = 12.5, width = 8.25)
print(feature)
dev.off()
```
